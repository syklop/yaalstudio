...
import { k as buildAssetsURL, j as useRuntimeConfig, l as getResponseStatusText, m as getResponseStatus, n as defineRenderHandler, o as publicAssetsURL, h as getQuery, c as createError, q as getRouteRules, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[],"noscript":[]};
