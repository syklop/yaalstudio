...
export default {
  ...
  watch: {
    ...
    showEmailComposer(isOpen) {
      // Gestion simple du scroll - les modales gèrent leur propre scroll
      if (isOpen) {
    ...
    showContactDetail(_isOpen) {
      // ContactDetailModal gère son propre scroll
      // Pas besoin de gérer ici
    },

    showSaveTemplate(_isOpen) {
      // SaveTemplateModal gère son propre scroll  
      // Pas besoin de gérer ici
    }
  },
  ...
  beforeUnmount() {
    // Restaurer le scroll du body au cas où le composant serait détruit avec une modale ouverte
    document.body.style.overflow = ''
  },
