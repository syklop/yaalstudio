                    ...
                    <div class="shortcuts-list">
                      ...
                      >
                        ...
                        <div class="shortcut-content">
                          <div class="shortcut-label">CRÉER CONTACTS DE TEST</div>
                          <div class="shortcut-description">Générer des données d'exemple pour tester</div>
                        </div>
                        <button @click="seedContacts" :disabled="seeding" class="shortcut-action">
                      ...
                      <div class="shortcut-item">
                        ...
                        <button @click="downloadData" class="shortcut-action">Exporter</button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="activity-list">
                      <div class="activity-item">
                        ...
                        <div class="activity-progress-bar">
                          <div class="activity-progress-fill new" style="width: 100%"></div>
                        </div>
                      </div>
                      ...
                      <div class="activity-item" v-if="selectedContacts.length > 0">
                        ...
                        <div class="activity-progress-bar">
                          <div class="activity-progress-fill selection" :style="{ width: `${Math.min((selectedContacts.length / stats.totalContacts) * 100, 100)}%` }"></div>
                        </div>
                      </div>
                      
                      <div class="activity-item">
                        <div class="activity-item-info">
                          <div class="activity-label">DERNIÈRE CAMPAGNE</div>
                          <div class="activity-value">Il y a 2h</div>
                        </div>
                        <div class="activity-progress-bar">
                          <div class="activity-progress-fill email" style="width: 75%"></div>
                        </div>
                      </div>
                      
                      <div class="activity-item">
                        <div class="activity-item-info">
                          <div class="activity-label">SYNCHRONISATION</div>
                          <div class="activity-value">OK</div>
                        </div>
                        <div class="activity-progress-bar">
                          <div class="activity-progress-fill sync" style="width: 100%"></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    downloadData() {
      // Créer un CSV avec les données des contacts
      if (this.contacts.length === 0) {
      ...
      const csvData = [
        ['Prénom', 'Nom', 'Email', 'Téléphone', 'Statut', 'Source', 'Date de création'],
      ...
      if (link.download !== undefined) {
        ...
        link.setAttribute('download', `yaalstudio-contacts-${new Date().toISOString().split('T')[0]}.csv`)
