import { hasInjectionContext, getCurrentInstance, inject, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, ref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, computed, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { c as createError$1, s as klona, w as defuFn, x as hasProtocol, y as isScriptProtocol, z as joinURL, A as withQuery, B as sanitizeStatusCode, C as getContext, $ as $fetch$1, D as baseURL, E as createHooks, F as executeAsync, G as toRouteMatcher, H as createRouter$1, I as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CoUiYV_7.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DpTkL_gz.mjs')
  },
  {
    name: "merci",
    path: "/merci",
    component: () => import('./merci-bZ9HrGzJ.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-C16XsIn9.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-DarDRla6.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DZNdf3_Z.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C98JH6PW.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry$1 as default, defineNuxtRouteMiddleware as e, asyncDataDefaults as f, createError as g, useAppConfig as h, navigateTo as n, resolveRouteObject as r, useRouter as u };
