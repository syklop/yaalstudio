  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        ...
        // Récupérer le sessionId pour le tracking des conversions
        const sessionId = import.meta.client ? localStorage.getItem('yaal_session_id') : null
        ...
        const response = await $fetch('/api/contacts/add', {
          ...
          body: {
            ...
            sessionId, // Ajouter le sessionId pour marquer la conversion
