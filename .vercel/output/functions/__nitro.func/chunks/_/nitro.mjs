import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { google } from 'googleapis';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f2f786b2-7a36-4f2a-a8d7-bcbb8963651f",
  ...
  "brevoApiKey": "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",
  "adminEmail": "oyone400@gmail.com",
  "sitemap": {
    "isI18nMapped": false,
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        "_context": "buildEnv",
        "_priority": -1,
        "description": "Votre partenaire créatif pour tous vos projets digitaux",
        "name": "YaalStudio",
...
const _RuocrGZ6WG7jEtVyyfbdwsrnrl5wP3_xdPoWUeX1L18 = defineNitroPlugin(async (nitroApp) => {
...
const _xFd9ENdr2BGJ4aFoa7V2hVQpf1IGn1vhQigp8PdKHds = (function(nitro) {
...
const plugins = [
  _RuocrGZ6WG7jEtVyyfbdwsrnrl5wP3_xdPoWUeX1L18,
_xFd9ENdr2BGJ4aFoa7V2hVQpf1IGn1vhQigp8PdKHds
];
...
const _EASChS = eventHandler(async (e) => {
...
const _psyqkW = defineEventHandler(async (e) => {
...
const _IqPMoD = defineEventHandler(async (e) => {
...
async function getGoogleSheetsClient() {
  ...
  console.log("\u{1F50D} Initialisation du client Google Sheets...");
  console.log("\u{1F527} Variables d'environnement disponibles:", {
  ...
  if (!config.googleClientEmail) {
    console.error("\u274C GOOGLE_CLIENT_EMAIL non d\xE9fini");
    throw new Error("GOOGLE_CLIENT_EMAIL non d\xE9fini dans les variables d'environnement");
  }
  if (!config.googlePrivateKey) {
    console.error("\u274C GOOGLE_PRIVATE_KEY non d\xE9fini");
    throw new Error("GOOGLE_PRIVATE_KEY non d\xE9fini dans les variables d'environnement");
  }
  if (!config.googleSheetsId) {
    console.error("\u274C GOOGLE_SHEETS_ID non d\xE9fini");
    throw new Error("GOOGLE_SHEETS_ID non d\xE9fini dans les variables d'environnement");
  }
  let privateKey;
  try {
    privateKey = config.googlePrivateKey.replace(/\\n/g, "\n").replace(/"/g, "").trim();
    if (!privateKey.includes("BEGIN PRIVATE KEY") || !privateKey.includes("END PRIVATE KEY")) {
      console.error("\u274C Format de cl\xE9 priv\xE9e invalide");
      throw new Error("Format de cl\xE9 priv\xE9e Google invalide");
    }
    console.log("\u2705 Cl\xE9 priv\xE9e format\xE9e correctement");
  } catch (error) {
    console.error("\u274C Erreur lors du formatage de la cl\xE9 priv\xE9e:", error.message);
    throw new Error("Erreur lors du formatage de la cl\xE9 priv\xE9e Google");
  }
  const credentials = {
  ...
  console.log("\u2705 Credentials reconstitu\xE9s pour:", credentials.client_email);
  try {
    ...
    console.log("\u2705 Authentification Google initialis\xE9e");
    await auth.getClient();
    console.log("\u2705 Client d'authentification obtenu");
    const sheets = google.sheets({ version: "v4", auth });
    console.log("\u2705 Client Google Sheets cr\xE9\xE9");
    return sheets;
  } catch (error) {
...
const googleSheets = /*#__PURE__*/Object.freeze({
  __proto__: null,
  getGoogleSheetsClient: getGoogleSheetsClient
});
...
function verifyToken(token) {
  try {
    ...
    console.error("\u274C Erreur v\xE9rification JWT:", error.message);
    return null;
  }
}
...
const _dZas4E = defineCachedEventHandler(async (event) => {
...
const _lazy_ca93ac = () => import('../routes/api/auth/login.post.mjs');
const _lazy_pB8wqD = () => import('../routes/api/auth/logout.post.mjs');
const _lazy_LYIxeh = () => import('../routes/api/auth/verify.get.mjs');
const _lazy_6wvLDC = () => import('../routes/api/contacts/add.post.mjs');
const _lazy_fIuuV5 = () => import('../routes/api/dashboard/analytics.get.mjs');
const _lazy_B5n5OV = () => import('../routes/api/dashboard/contacts.get.mjs');
const _lazy_8vePmm = () => import('../routes/api/dashboard/contacts/_id_.patch.mjs');
const _lazy_4MMrpM = () => import('../routes/api/dashboard/emails/send-mass.post.mjs');
const _lazy_E9ktNR = () => import('../routes/api/dashboard/stats.get.mjs');
const _lazy_NF9W2I = () => import('../routes/api/database-status.get.mjs');
const _lazy_eJw3iO = () => import('../routes/api/emails/confirmation.post.mjs');
const _lazy_TBbrbD = () => import('../routes/api/seed-contacts.post.mjs');
const _lazy_nxyHIW = () => import('../routes/api/test-google-sheets.get.mjs');
const _lazy_P37zIE = () => import('../routes/api/test-login.get.mjs');
const _lazy_Mi6V5f = () => import('../routes/api/track-visitor.post.mjs');
const _lazy_N005Nx = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/auth/login', handler: _lazy_ca93ac, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_pB8wqD, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/verify', handler: _lazy_LYIxeh, lazy: true, middleware: false, method: "get" },
  { route: '/api/contacts/add', handler: _lazy_6wvLDC, lazy: true, middleware: false, method: "post" },
  { route: '/api/dashboard/analytics', handler: _lazy_fIuuV5, lazy: true, middleware: false, method: "get" },
  { route: '/api/dashboard/contacts', handler: _lazy_B5n5OV, lazy: true, middleware: false, method: "get" },
  { route: '/api/dashboard/contacts/:id', handler: _lazy_8vePmm, lazy: true, middleware: false, method: "patch" },
  { route: '/api/dashboard/emails/send-mass', handler: _lazy_4MMrpM, lazy: true, middleware: false, method: "post" },
  { route: '/api/dashboard/stats', handler: _lazy_E9ktNR, lazy: true, middleware: false, method: "get" },
  { route: '/api/database-status', handler: _lazy_NF9W2I, lazy: true, middleware: false, method: "get" },
  { route: '/api/emails/confirmation', handler: _lazy_eJw3iO, lazy: true, middleware: false, method: "post" },
  { route: '/api/seed-contacts', handler: _lazy_TBbrbD, lazy: true, middleware: false, method: "post" },
  { route: '/api/test-google-sheets', handler: _lazy_nxyHIW, lazy: true, middleware: false, method: "get" },
  { route: '/api/test-login', handler: _lazy_P37zIE, lazy: true, middleware: false, method: "get" },
  { route: '/api/track-visitor', handler: _lazy_Mi6V5f, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_N005Nx, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _EASChS, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _psyqkW, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _IqPMoD, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _dZas4E, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_N005Nx, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withQuery as A, sanitizeStatusCode as B, getContext as C, baseURL as D, createHooks as E, executeAsync as F, toRouteMatcher as G, createRouter$1 as H, defu as I, withTrailingSlash as J, withoutTrailingSlash as K, googleSheets as L, prisma as a, getExpiryDate as b, createError$1 as c, defineEventHandler as d, getHeader as e, extractTokenFromHeader as f, generateToken as g, getQuery as h, getRouterParam as i, useRuntimeConfig as j, buildAssetsURL as k, getResponseStatusText as l, getResponseStatus as m, defineRenderHandler as n, publicAssetsURL as o, parseQuery as p, getRouteRules as q, readBody as r, klona as s, toNodeListener as t, useNitroApp as u, verifyToken as v, defuFn as w, hasProtocol as x, isScriptProtocol as y, joinURL as z };
